...
In der Umsetzung sollen für jeden Zusatandsübergang Kalmanfilter auf einem Featurevektor trainiert werden. Die Reihenfolge der Auswertung des Kalmanfilters wird durch die Zustandsübergangswahrscheinlichkeiten der Markovkette bestimmt. Da die Kalmanfilter vorher auf allen Frames, die mit dem gegebenen Zustand annotiert sind, trainiert werden um eine individualle Binäre Klassifikation durchzuführen, erfüllen Sie das Markovkriterium nur teilweise.
Sie nutzen die Informationen der vorherigen Frames nicht direkt sondern über das Training. Deshalb bewerten Sie den Übergang anhand des gelernten Durchschnittsmodell. Dieser Wert wird für die Wahrscheinlikeitsberechnung des nächsten Zustandsübergangs aufgenommen. Der aktuelle Zustand wird mit dem Wissen aus der Vergangenheit bestimmt. Daher verhält sich das Gesamtsystem wie ein bedingtes Random Field (CRF), in dem die Kalmanfilter die lokalen Beobachtungen modellieren und die Markov-Kette die Abhängigkeiten zwischen den Zuständen über die Zeit steuert.
\noindent
