...
%************************************************
Die Durchführung von Endoskopien ist ein wesentlicher Bestandteil der modernen medizinischen Diagnostik. Mit dem Aufkommen von Künstlicher Intelligenz (KI) und maschinellem Lernen (ML)eröffneten sich in den letzten Jahren neue Möglichkeiten zur Automatisierung und Verbesserung der Analyse von Endoskopie-Videos. Durch konvolutionale neuronale Netze zum Beispiel ist eine framebasierte Segmentierung von Endoskopie-Videos durch das Training immer besser möglich. Speziell im Bereich der Adenomdetektionsrate gab es hier große Fortschritte. 
%#TODO Quellen einfügen
 Diese Arbeit konzentriert sich auf die Optimierung der Vorhersagen verschiedener Regionen von Endoskopievideos durch den Einsatz von Markov Models und Conditional Random Fields als Wrapperfunktion.

\section{Gegenstand}

\subsection{Endoskopie als diagnostisches Werkzeug - Vielfältige Methoden bei der Bildgebung}

Endoskopie ist ein weit verbreitetes diagnostisches Werkzeug in der Medizin. Die Untersuchung verschiedener Organe mit einer Kamera hat in der minimalinvasiven Untersuchung sowie der Chirurgie erhebliche Vorteile, sodass ihr Einsatz omnipräsent ist. Da mit steigendem Einsatz von besserer Bildgebung Krankheiten wie Darmkrebs im Schnitt schneller erkannt werden, sinkt das Darmkrebsrisiko sowie die Mortalität auf lange Sicht in Gruppen, die sich einer Vorsorgekoloskopie unterziehen. \cite{doi:10.1056/NEJMoa2208375}\cite{Doubeni291}\cite{doi:10.7326/M17-0723} Aus diesem Grund veröffentlichen Verbände wie die Deutsche Gesellschaft für Viszeralmedizin regelmäßige Richtlinien zur Anzahl der durchgeführten Endoskopien. Um sich als Exzellenzzentrum zu qualifizieren, muss ein Krankenhaus in Deutschland beispielsweise mindestens 2500 endoluminale Endoskopien durchführen \citep{dgav-ev-2015}. Das ist ein erheblicher Aufwand. In Anbetracht des aktuellen Ärztemangels wird ohnehin die Delegation ärztlicher Aufgaben durch Digitalisierung als wichtiges Thema aufgegriffen, wie 2025 eine Umfrage unter 400 angehenden Ärztinnen und Ärzten zeigte. \cite{Junghanns2025Ärztebarometer}. Von diesen Maßnahmen erhofft man sich eine Reduktion der Arbeitslast. Speziell in der Gastroenterologie fallen durch die Größe des untersuchten Gewebes im Darm und der Notwendigkeit für Vorsorgekoloskopien große Datenmengen an. Eine häufig durchgeführte gastroenterologische Anwendung ist die Koloskopie (Endoskopie im Dickdarm). Sie dient der Vorsorgeuntersuchungen und zur Kontrolle von Adenomen und ihrem Wachstum. Wenn Patienten zur Erkennung von Polypen erscheinen, ist die Chance tödliche Darmkrebsverläufe im Kolon zu verhindern erwiesenermaßen höher. Polypen, die als Vorstufe von Darmkrebs gelten, können während der Kolonoskopie so im Kolon, bis zum Ileum, direkt in der Vorsorgeuntersuchungen routinemäßig erkannt und entfernt werden. Das ist auch relevant für die Behandlung von Patienten mit bekannten Risikofaktoren wie entzündlichen Darmerkrankungen \citep{vleggaar-2007}. Diese Patienten sollten besonders präventiv in Routineuntersuchungen gescreent. \citep{arnold-2020}.

Die Endoskopie wird seit ihrer flächendeckenden Einführung in vielen Industrieländern weiterentwickelt. Die Geräte machen beispielsweise in der Auflösung sowie bei bildgebenden Verfahren Forschritte. Die Nutzung von NBI wird mittlerweile an vielen Standorten zur Hervorhebung von Polypen genutzt \cite{yasushi2016nbi}. Auch die Kapselendoskopie bietet als minimalinvasives Verfahren viele Vorteile. Durch den Durchlauf einer Kapsel im Körper kann sie bei Verdacht auf Vorliegen einer Blutungsquelle im Darm sowie bei Verdacht auf Dünndarmpolypen oder Morbus Crohn im Dünndarm hervorragend genutzt werden. Mit dem Aufkommen kostengünstigerer Methoden wie der Kapsel-Endoskopie wird erwartet, dass die Anzahl der zu analysierenden Videos steigen wird \citep{koulaouzidis-2021}\citep{8903282}. Diese Zahlen, kombiniert mit der drohenden Gefahr verschiedener kolorektaler Krebsarten in steigenden Zahlen \citep{acs-2024,ferlay-2024}, unterstreichen die Notwendigkeit weiterer Forschung zur Verbesserung des Screening-Prozesses in Vorbereitung, Durchführung und Nachbearbeitung\citep{kaminski_performance_2017}.

\subsection{KI-gestützte Segmentierung in der Endoskopie}

Die Verbesserung des Endoskopie-Workflows könnte in Zukunft durch KI-basierte Segmentierung für schnelleres Screening und Dokumentation erfolgen. Hier haben Lux et.al. in einer früheren Publikation eine nutzbare Segmentierungspipeline demonstriert, die in dieser Masterarbeit aufgegriffen und verwendet werden soll \cite{lux-2023}.

Die Pipeline basiert auf einer Multi-Label-KI, die die Wahrscheinlichkeit von für die aktuelle Endoskopie wichtigen Labels vorhersagt. Die Labels werden verwendet, um das Video in Kategorien zu segmentieren. Ein finetuned RegNetX800MF-Modell sagt die Wahrscheinlichkeit von für den aktuellen Endoskopie-Frame wichtigen Labels Frame für Frame voraus. Die Labels werden verwendet, um das Video in Kategorien zu segmentieren. Die Segmentierung kann bei ausreichender Genauigkeit dazu verwendet werden, dem Arzt eine Zusammenfassung des Videos zu liefern. Auch der Einsatz solcher Systeme bei der Entscheidungsunterstützung wurde bereits evaluiert, hierbei kann es jedoch dazu kommen, dass die Konzentration der Untersucher nachlässt \cite{hann_entscheidungsunterstutzung_2025}.
...
Dieser Ansatz wurde in mehreren Studien getestet, wie der von Vilmann et. al.\cite{vilmann-2022} durchgeführten Studie, die zeigte, dass die Zökum-Rückzugszeit mit der Adenom-Detektionsrate verbunden ist \citep{vilmann-2022}.
...
Diese Probleme treten insbesondere bei Ein- und Austritt des Endoskops in den Körper auf, da sich hier die Lichtverhältnisse rapide ändern.
...
Als optimaler Ausgang kann das System die Verwendung des CNN Segmentationsmodell teilweise oder vollständig ersetzen.
Die Minimalanforderung an ein erfolgreiches System wäre die zuverlässige Klassifizierung insbesondere des Eintretens in den Körper sowie die Erkennung des terminalen Ileums zur Berechnung der Zökum-Rückzugsszeit. ($\delta(Z_1, Z_2)$, wobei Zeitpunkt $Z_1$ das Erreichen des terminalen Ileums und $Z_2$ der Zeitpunkt des Austritts aus dem Körper ist.)
Diese Werte können in der Qualitätssicherung einer Endoskopie sowie zur Qualitätssicherung eingesetzt werden.
